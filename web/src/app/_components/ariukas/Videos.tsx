...
export default function VideoGallery() {
	...
	return (
		<div className="absolute w-full md:h-[50%] bottom-18 overflow-hidden overflow-y-scroll py-8 px-8 flex justify-center overflow-x-scroll">
			<div className="flex gap-10 lg:grid lg:grid-cols-2 md:grid md:grid-cols-3">
