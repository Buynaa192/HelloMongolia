      ...
      <div className="flex flex-col gap-2 w-full">
        <div className="flex items-center gap-4">
          ...
          <p className="text-2xl font-semibold italic">
            {pack?.duration} of {pack?.tripType}
          </p>
        </div>
            ...
            return (
              ...
              >
                <AccordionTrigger className="w-full p-0 flex items-center hover:no-underline">
                  <div className="w-full flex items-center gap-8 py-2 cursor-pointer">
                    <p className="text-muted-foreground">Day {index + 1}</p>
                    ...
                    {item.activity.map((item) => {
                      return (
                        <Button
                          key={item._id}
                          size="sm"
                          className="text-yellow-500 gap-2 items-center"
                        >
                          <p>{item.emoji}</p>
        ...
        <div className="w-full flex justify-between items-center mt-6">
          <p className="font-semibold text-3xl">
            <span className="text-xl text-muted-foreground">Cost: </span>$
